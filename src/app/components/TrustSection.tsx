...
const TRUST_STATS = [
  {
    ...
    description: 'Weddings, funerals, birthdays & corporate events',
  },
  {
    id: 'stat-clients',
    icon: Users,
    ...
    description: 'Trusted by families and businesses across SA',
  },
  {
    id: 'stat-loans',
    icon: TrendingUp,
    ...
    description: 'Financial support delivered to our community',
  },
  {
    id: 'stat-years',
    icon: Award,
    ...
    description: 'Industry expertise since 2016',
  },
  {
    id: 'stat-rating',
    icon: Star,
    ...
    description: 'Based on 340+ verified client reviews',
  },
  {
    id: 'stat-repay',
    icon: Shield,
    ...
    description: 'Responsible lending, community first',
  },
];
...
const TESTIMONIALS = [
  {
    ...
    quote:
      'VSM delivered beyond our expectations. Every photo tells a story we will treasure forever.',
    rating: 5,
    avatar: 'ND',
  },
  {
    ...
    quote:
      "The financing process was seamless. I was able to afford my daughter's graduation photoshoot without stress.",
    rating: 5,
    avatar: 'TM',
  },
  {
    ...
    quote:
      'Professional, punctual, and absolutely cinematic. Our product launch looked like a Netflix production.',
    rating: 5,
    avatar: 'SK',
  },
];
      ...
      <div className="max-w-screen-2xl mx-auto px-6 lg:px-10 xl:px-16">
        ...
        >
          ...
          <h2 className="font-display text-4xl lg:text-5xl font-light text-foreground mb-4">
            Trust Built Through <span className="text-gradient-gold italic">Results</span>
          </h2>
          <p className="text-foreground-muted max-w-xl mx-auto text-base leading-relaxed">
            Eight years of delivering cinematic memories and responsible financial services to South
            African communities.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4 mb-20">
          {TRUST_STATS.map((stat, i) => (
            ...
            >
              ...
              <div className="text-xs font-semibold text-foreground tracking-wide mb-1">
                {stat.label}
              </div>
              <div className="text-xs text-foreground-muted leading-relaxed hidden xl:block">
                {stat.description}
              </div>
            </motion.div>
          ))}
